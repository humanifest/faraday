...
declared context kind. Context and proposal purpose bindings, context handles,
proposal IDs, generator provider/model handles, suggestion IDs, evidence
references, review IDs, reviewer handles, and review-decision suggestion IDs
...
citation, source identity, or review obligation. The resulting record remains
...
provider or API-cost dependency.
