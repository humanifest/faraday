...
criterion/calibration IDs must already be canonical without surrounding
whitespace; receipt-side required custody-gate and frozen calibration IDs are
normalized later before receipt coverage is accepted.
