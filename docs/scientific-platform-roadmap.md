...
material or receipts are replayed.
...
verification identities are canonical at the same boundary, so retained custody
records cannot hide distinct-looking provenance behind later whitespace
normalization.
