...
The bundled missingness report normalizes requested column names before duplicate
checks and pattern counting, so padded diagnostic specifications cannot create
separate apparent missingness fields.
